...
async function analyzeFixture(apiBaseUrl, session, fixture, imageBase64) {
...
async function benchmarkFixture(apiBaseUrl, session, manifest, fixture, imageBase64) {
...
async function main() {
  ...
  for (const fixture of manifest.fixtures) {
    ...
    const analyzeResult = await analyzeFixture(apiBaseUrl, session, fixture, imageBase64);
    ...
    const benchmarkResult = await benchmarkFixture(apiBaseUrl, session, manifest, fixture, imageBase64);
