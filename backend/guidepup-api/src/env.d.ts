/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/env.d.ts` (hash: b229ebb213a92072ff6ddb2ce598d515)
// Runtime types generated with workerd@1.20260329.1 2026-03-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "DeviceRateLimiter";
	}
	interface StagingEnv {
		...
		RATE_LIMITER: DurableObjectNamespace<import("./index").DeviceRateLimiter>;
	}
	...
	interface Env {
		...
		EXPECTED_API_URL: "https://guidepup-api-staging.charliehan-lifepage.workers.dev" | "https://guidepup-api-production.charliehan-lifepage.workers.dev" | "";
		VISION_PROVIDER: "openai-compatible";
		EXPERIMENTAL_MINICPM_O_BENCHMARK: "false";
		HUGGINGFACE_MINICPM_O_BASE_URL: "";
		HUGGINGFACE_MINICPM_O_MODEL: "openbmb/MiniCPM-o-2_6";
		...
		PROMPT_VERSION: "2026-07-18.v1";
		RATE_LIMIT_PER_MINUTE: "20";
		SESSION_TTL_SECONDS: "3600" | "86400";
		SOURCE_REVISION: "development";
		CORS_ORIGIN: "" | "*";
		CORS_ALLOWED_ORIGINS: "";
		DEBUG_BENCHMARK_TOKEN: "";
		WORKER_IDENTITY: "guidepup-api-staging" | "guidepup-api-production" | "guidepup-api";
		BOOTSTRAP_SIGNING_SECRET: string;
		OPENAI_API_KEY: string;
		RATE_LIMITER: DurableObjectNamespace<import("./index").DeviceRateLimiter>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANALYZE_IP_RATE_LIMIT_PER_MINUTE" | "AI_GATEWAY_BASE_URL" | "AI_GATEWAY_AUTH_HEADER" | "AI_GATEWAY_AUTH_PREFIX" | "AI_GATEWAY_PATH" | "AI_GATEWAY_FALLBACK_BASE_URL" | "AI_GATEWAY_FALLBACK_AUTH_HEADER" | "AI_GATEWAY_FALLBACK_AUTH_PREFIX" | "AI_GATEWAY_FALLBACK_PATH" | "BOOTSTRAP_RATE_LIMIT_PER_MINUTE" | "ENVIRONMENT" | "EXPECTED_API_URL" | "VISION_PROVIDER" | "EXPERIMENTAL_MINICPM_O_BENCHMARK" | "HUGGINGFACE_MINICPM_O_BASE_URL" | "HUGGINGFACE_MINICPM_O_MODEL" | "OPENAI_BASE_URL" | "OPENAI_MAX_COMPLETION_TOKENS" | "OPENAI_MODEL" | "OPENAI_REQUEST_TIMEOUT_MS" | "OPENAI_RETRY_COUNT" | "OPENAI_RETRY_DELAY_MS" | "OPENAI_REASONING_EFFORT" | "PROVIDER_ALLOWED_ORIGINS" | "PROVIDER_GLOBAL_CALL_LIMIT_PER_MINUTE" | "PROMPT_VERSION" | "RATE_LIMIT_PER_MINUTE" | "SESSION_TTL_SECONDS" | "SOURCE_REVISION" | "CORS_ORIGIN" | "CORS_ALLOWED_ORIGINS" | "DEBUG_BENCHMARK_TOKEN" | "WORKER_IDENTITY" | "BOOTSTRAP_SIGNING_SECRET" | "OPENAI_API_KEY">> {}
}
